...
etiketlenenKişi.roles.add(ayarlar.ErkekRol)
etiketlenenKişi.roles.add(ayarlar.ErkekRo2)
...
client.channels.cache.get(ayarlar.sohbetKanal).send(`${etiketlenenKişi} **kaydolarak sunucuya giriş yaptı. Hoş geldin!**`)
